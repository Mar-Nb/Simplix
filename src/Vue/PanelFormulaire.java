 ...
 * <p>Ce panel contient les deux formulaires de création de simplexe de l'application : <code>PanelChoixNombresMonomesContraintes</code> et
...
public class PanelFormulaire extends JPanel{
	 ...
	 * <p>Met le paramètre <code>controleur</code> à l'écoute du champ <i>panelCMC</i> de <i><b>this</b></i>.</p>
	 ...
	 * <h1><i>enregistreEcouteur</i></h1>
	 * <h2><code>public void enregistreEcouteur(Controleur controleur)</code></h2>
	 * <p>Met le paramètre <code>controleur</code> à l'écoute du champ <i>panelC</i> de <i><b>this</b></i>.</p>
	 * @param controleur : (Controleur)
	 */
	 ...
	 * <p>Définit le champ <i>panelC</i> de <i><b>this</b></i> avec le <code>PanelContraintes</code> donné en param�tre.</p>
