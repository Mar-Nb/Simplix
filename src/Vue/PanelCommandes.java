...
public class PanelCommandes extends JPanel implements Data {
	...
	/**
	 * Titre concernant le nom de l'entête
	 */
	...
	public PanelCommandes(Matrice pMatrice) {
		...
		// instance et ajout des boutons flèches
		...
		// instance et ajout des boutons d'opération
		...
		// on y ajoute les panels créés précèdemment
